...
$nombre = $_FILES['acnam']['name'];
$tempnom = $_FILES['acnam']['tmp_name'];
$ruta = "docalumn/" . $noreg . "/actaNacim.pdf";
$dest = "docalumn/" . $noreg;
...
if (!file_exists($directorio)) {
    ...
    if (file_exists($directorio)) {
        ...
        if (move_uploaded_file($tempnom, $ruta)) {
            ...
            $query = 'UPDATE pendiente SET actnacim = 1, carpeta = "' . $dest . '"  WHERE noregistro = "' . $noreg . '" ';
