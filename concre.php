...
$nombre = $_FILES['concre']['name'];
$tempnom = $_FILES['concre']['tmp_name'];
$ruta = "docalumn/" . $noreg . "/ConstCreditos.pdf";
$dest = "docalumn/" . $noreg;
...
if (!file_exists($directorio)) {
    ...
    if (file_exists($directorio)) {
        ...
        if (move_uploaded_file($tempnom, $ruta)) {
            ...
            $query = 'UPDATE pendiente SET conscredit = 1, carpeta = "' . $dest . '"  WHERE noregistro = "' . $noreg . '" ';
