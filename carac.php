...
$nombre = $_FILES['carac']['name'];
$tempnom = $_FILES['carac']['tmp_name'];
$ruta = "docalumn/" . $noreg . "/cargaAcadem.pdf";
$dest = "docalumn/" . $noreg;
...
if (!file_exists($directorio)) {
    ...
    if (file_exists($directorio)) {
        ...
        if (move_uploaded_file($tempnom, $ruta)) {
            ...
            $query = 'UPDATE pendiente SET cargacadem = 1, carpeta = "' . $dest . '"  WHERE noregistro = "' . $noreg . '" ';
