...
$nombre = $_FILES['sss']['name'];
$tempnom = $_FILES['sss']['tmp_name'];
$ruta = "docalumn/" . $noreg . "/solicitudServicio.pdf";
$dest = "docalumn/" . $noreg;
...
if (!file_exists($directorio)) {
    ...
    if (file_exists($directorio)) {
        ...
        if (move_uploaded_file($tempnom, $ruta)) {
            ...
            $query = 'UPDATE pendiente SET solservsoci = 1, carpeta = "' . $dest . '"  WHERE noregistro = "' . $noreg . '" ';
